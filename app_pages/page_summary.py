...
def page_summary_body():
    ...
    st.success(
        ...
        f"* 1 - My friend is interested in discovering how exactly house "
        f"attributes correlate with the sale price.\n"
        f"  * My friend expects data visualizations of the correlated "
        f"variables against the sale price.\n"
        f"* 2 - My friend is interested in predicting the house sales price "
        f"for his refurbished houses, "
