...
- Inspiration: Certain elements presented in the project and readme file were inspired from these 2 repositories: [repository 1](https://github.com/Vasi012/PP5-Predictive-Analysis) and [repository 2](https://github.com/Amareteklay/heritage-housing-issues).
